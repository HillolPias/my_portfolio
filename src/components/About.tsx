        ...
        >
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-lg text-dark/70 dark:text-light/70 max-w-3xl mx-auto">
              I'm a passionate developer with a strong focus on creating elegant solutions that solve real-world problems. With over 4 years of experience, I've worked on a wide range of projects across various industries.
            </p>
          </motion.div>
